...
const gracefulShutdown = (pid) => {
    ...
    try {
        // Check if the process exists before sending SIGTERM
        process.kill(pid, 0);  // This checks if the process exists without killing it
        ...
        try {
            ...
            console.error(`Failed to force kill process ${pid}: ${killErr.message}`);
        }
    }
};

// Example of how to use it in your killProcessOnPort method
